...
# For QEC LS closed-loop calibration
# usage: 
...
# 	./diora_rfloop_3qb2.sh 0 7000000
...
CFreq=$(( $freq * 500 ))
trx_offset=45000000
CFreq_rx=$(( $CFreq - $trx_offset ))
rx_freq=$(( CFreq_rx/500 ))
tx_gain=19
rx_gain=7
...
{
echo
echo Initialize RF sequence for QEC closed-loop calibration...
echo
echo Slot = $slot
echo TXPLL frequency = $CFreq
echo RXPLL frequency = $CFreq_rx
echo Tx-Rx PLL offset = $trx_offset
...
dio "diora-setgain 12 1 0 1 10"
dio "diora-setgain 3 1 0 1 7"
...
dio "diora-setcalpll 1 ${rx_freq}"

dio "diora-setrfloop 3 2 1"
dio "diora-setdpd 3 0"
dio "diora-setlna 3 0"
dio "diora-setpa 3 1"
dio "diora-txrxsw 0"
